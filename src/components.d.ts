...
declare global {
  ...
  interface HTMLGiotramuLogoElement extends Components.GiotramuLogo, HTMLStencilElement {}
  var HTMLGiotramuLogoElement: {
    prototype: HTMLGiotramuLogoElement;
    new (): HTMLGiotramuLogoElement;
  };

  interface HTMLGiotramuLogotypeElement extends Components.GiotramuLogotype, HTMLStencilElement {}
  var HTMLGiotramuLogotypeElement: {
    prototype: HTMLGiotramuLogotypeElement;
    new (): HTMLGiotramuLogotypeElement;
  };

  interface HTMLGiotramuMonogramElement extends Components.GiotramuMonogram, HTMLStencilElement {}
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      'giotramu-logo': LocalJSX.GiotramuLogo & JSXBase.HTMLAttributes<HTMLGiotramuLogoElement>;
      'giotramu-logotype': LocalJSX.GiotramuLogotype & JSXBase.HTMLAttributes<HTMLGiotramuLogotypeElement>;
      'giotramu-monogram': LocalJSX.GiotramuMonogram & JSXBase.HTMLAttributes<HTMLGiotramuMonogramElement>;
    }
  }
}
